    ...
    <div className="explosive-about-container">
      <div className="explosive-about-card">
        ...
        <p className="explosive-about-body">
          ...
          to fine dining aesthetics, every meal we deliver is a <span className="explosive-about-highlight" style={{background: '#00e5ff', transform: 'rotate(2deg)'}}>masterpiece</span>.
        </p>
      </div>
    </div>
  </section>
